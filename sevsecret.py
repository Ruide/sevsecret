...
if __name__ == "__main__":
    ...
    ##
    # in grub source api.h
    # GRUB_EFI_SECRET_TABLE_HEADER_GUID { 0x1e74f542, 0x71dd, 0x4d66, { 0x96, 0x3e, 0xef, 0x42, 0x87, 0xff, 0x17, 0x3b }}
    # GRUB_EFI_DISKPASSWD_GUID { 0x736869e5, 0x84f0, 0x4973, { 0x92, 0xec, 0x06, 0x87, 0x9c, 0xe3, 0xda, 0x0b }}
    #
